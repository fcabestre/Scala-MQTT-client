...
object SpecUtils {
  ...
  class SpecsTestKit extends TestKit(ActorSystem("MQTTClient-system", ConfigFactory.parseString(configDebug))) with ImplicitSender with Scope with AfterExample {
